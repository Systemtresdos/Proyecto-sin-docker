<x-layouts.app title="Roles" :breadcrumbs="['Roles']">
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        <h1 class="text-2xl font-bold text-center mb-6">Confirmar Pago Simulado</h1>
        ...
        <div class="mb-4">
            <h2 class="text-lg font-semibold">Detalles del Pedido (Simulado)</h2>
            <p><strong>Nro. Pedido:</strong> {{ $pedido->nro_pedido }}</p>
<p><strong>Cliente:</strong> {{ $pedido->cliente->nombre ?? 'N/A' }} {{ $pedido->cliente->apellido_paterno ?? '' }}</p> {{-- Asumiendo relación cliente --}}
