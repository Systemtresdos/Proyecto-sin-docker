...
<<<<<<< HEAD
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] min-h-screen">
        <!-- Barra de navegación -->
        <header class="sticky top-0 z-50 bg-[#1b1b18] dark:bg-[#1a1a1a] shadow-sm">
            <div class="container mx-auto px-4 py-3 flex justify-between items-center">
                <!-- Logo -->
                <div class="flex items-center">
                    <a href="/" class="text-2xl font-bold text-[#E63946]">
                ...
                <div class="flex items-center space-x-3">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="px-4 py-2 bg-[#E63946] text-white rounded-md hover:bg-[#C1121F] transition">
                            Mi Cuenta
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="px-4 py-2 text-[#1b1b18] dark:text-[#EDEDEC] hover:text-[#E63946] transition">
                            Iniciar Sesión
                        </a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="px-4 py-2 bg-[#E63946] text-white rounded-md hover:bg-[#C1121F] transition sm:inline-block">
                                Registrarse
                            </a>
                        @endif
                    @endauth
